...
<template>
    <section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5">
        ...
        <el-dialog
            ...
            width="30%"
        >
            <h3 class="text-lg text-gray-800 dark:text-white mb-6">{{ isEditItem ? 'Edit Brand' : 'Add Brand' }}</h3>
            <form @submit.prevent="isEditItem ? updateBrand() : AddBrand()">
                <div class="mb-6">
            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        <tr v-for="(item, index) in brands.data" :key="item.id" class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div :id="`${item.id}`"
                                    ...
                                    <div class="py-1">
                                        <a href="#" @click="deleteBrand(item, index)" class="block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
