  ...
  <nav
    ...
    <div class="flex flex-wrap justify-between items-center">
      ...
      <div class="flex items-center lg:order-2">
        ...
        <!-- Dark mode -->
        <el-switch v-model="isDark" class="mr-3" :active-action-icon="Moon"
          style="--el-switch-on-color: #13ce66; --el-switch-off-color: #427D9D" :inactive-action-icon="Sunny" />
        <!-- Notifications -->
        ...
        <button type="button"
          ...
          <img class="w-8 h-8 rounded-full"
            src="https://i.pinimg.com/564x/e0/20/de/e020ded48faf037c92216cf401c99aa0.jpg" alt="user photo" />
        </button>
        <!-- Dropdown menu -->
        <div
          ...
          id="dropdown">
          <div class="py-3 px-4">
            <span class="block text-sm font-semibold text-gray-900 dark:text-white">Zac Azn</span>
            <span class="block text-sm text-gray-900 truncate dark:text-white">zac@cloe.com</span>
          </div>
