                                    ...
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <input type="number" id="first_product"
                                                ...
                                                class="bg-primary-200 w-14 border border-primary-300 text-primary-600 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block px-2.5 py-1 dark:bg-primary-700 dark:border-primary-600 dark:placeholder-primary-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                ...
                <div class="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <button v-if="formFilled || userAddress" type="submit"
                            class="text-white bg-primary-500 border-0 py-2 px-6 focus:outline-none hover:bg-primary-600 rounded text-lg">Checkout</button>

                        <button v-else type="submit"
                            class="text-white bg-primary-400 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg">Add
